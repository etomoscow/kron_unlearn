...
MANIFEST="${LOG_DIR}/${RUN_TAG}_SimNPO_e${EPOCHS}.tsv"
...
for seed in 0 1 2; do
  for arm in scratch kforge; do
    ckpt="saves/unlearn/tofu_gemma-3-1b-it_forget10_SimNPO_${arm}_S50_seed${seed}_rebuttal_gemma3_tuned080_v1"
    task="tofu_gemma-3-1b-it_forget10_SimNPO_${arm}_matched_S50_seed${seed}_relearn_e${EPOCHS}_${RUN_TAG}"
...
echo "[$(date -Is)] Gemma matched SimNPO relearning e${EPOCHS} complete"
